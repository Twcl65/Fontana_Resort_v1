...
export default function AdminCalendarPage() {
  ...
  const slots = useMemo(
    () => buildMonthSlots(cursor.year, cursor.month),
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-xs text-muted-foreground">
          Days reflect reservation status from the database (confirmed = booked, pending = pending approval).
        </p>
        ...
        <CardHeader className="flex flex-row flex-wrap items-center justify-between gap-3 border-b bg-muted/40 py-3">
          ...
          <div className="flex flex-1 flex-wrap items-center justify-between gap-3 sm:justify-end">
            <div>
              ...
              <p className="text-xs text-muted-foreground">All cottages · consolidated view</p>
            </div>
